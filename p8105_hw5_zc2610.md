...
```
    ...
    ##    <dbl>  <dbl>   <dbl> <chr>         
    ##  1     1  1.93   0.0523 fail to reject
    ##  2     1  2.43   0.0112 reject        
    ##  3     1  0.139  0.863  fail to reject
    ##  4     1  0.651  0.488  fail to reject
    ##  5     1  1.22   0.190  fail to reject
    ##  6     1  0.510  0.464  fail to reject
    ##  7     1  0.469  0.589  fail to reject
    ##  8     1  1.71   0.0711 fail to reject
    ##  9     1  1.70   0.0490 reject        
    ## 10     1  0.151  0.857  fail to reject
    ## # … with 290 more rows
