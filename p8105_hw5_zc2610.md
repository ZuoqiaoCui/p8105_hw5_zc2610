...
```
    ...
    ##    <dbl>   <dbl>   <dbl> <chr>         
    ##  1     1  2.95   0.00299 reject        
    ##  2     1  0.0820 0.928   fail to reject
    ##  3     1 -0.742  0.319   fail to reject
    ##  4     1  2.38   0.00832 reject        
    ##  5     1  2.29   0.0170  reject        
    ##  6     1  1.29   0.267   fail to reject
    ##  7     1  0.204  0.788   fail to reject
    ##  8     1  1.99   0.0289  reject        
    ##  9     1  1.23   0.266   fail to reject
    ## 10     1  0.880  0.349   fail to reject
    ## # … with 290 more rows
