...
```
    ...
    ##    <dbl>  <dbl>   <dbl> <chr>         
    ##  1     1  0.657  0.445  fail to reject
    ##  2     1  1.06   0.234  fail to reject
    ##  3     1  0.919  0.279  fail to reject
    ##  4     1  2.40   0.0177 reject        
    ##  5     1  1.16   0.128  fail to reject
    ##  6     1  0.234  0.800  fail to reject
    ##  7     1  0.463  0.682  fail to reject
    ##  8     1  0.737  0.460  fail to reject
    ##  9     1  0.965  0.186  fail to reject
    ## 10     1 -0.262  0.825  fail to reject
    ## # … with 290 more rows
