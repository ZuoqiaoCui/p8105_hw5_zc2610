...
```
    ...
    ##    <dbl>  <dbl>   <dbl> <chr>         
    ##  1     1  1.60   0.144  fail to reject
    ##  2     1  1.40   0.194  fail to reject
    ##  3     1 -1.63   0.0324 reject        
    ##  4     1 -0.405  0.694  fail to reject
    ##  5     1  2.11   0.0203 reject        
    ##  6     1  0.107  0.896  fail to reject
    ##  7     1  1.55   0.111  fail to reject
    ##  8     1  0.257  0.781  fail to reject
    ##  9     1  0.331  0.759  fail to reject
    ## 10     1  0.352  0.637  fail to reject
    ## # … with 290 more rows
