...
```
    ...
    ##    <dbl>   <dbl>    <dbl> <chr>         
    ##  1     1  1.61   0.0851   fail to reject
    ##  2     1  0.508  0.576    fail to reject
    ##  3     1  0.464  0.493    fail to reject
    ##  4     1 -0.809  0.383    fail to reject
    ##  5     1  0.589  0.513    fail to reject
    ##  6     1  0.0993 0.921    fail to reject
    ##  7     1  1.52   0.181    fail to reject
    ##  8     1  0.572  0.559    fail to reject
    ##  9     1  1.39   0.145    fail to reject
    ## 10     1  2.64   0.000840 reject        
    ## # … with 290 more rows
