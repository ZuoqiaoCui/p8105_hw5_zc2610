...
```
    ...
    ##    <dbl>  <dbl>   <dbl> <chr>         
    ##  1     1  0.298  0.765  fail to reject
    ##  2     1  0.425  0.638  fail to reject
    ##  3     1  0.728  0.394  fail to reject
    ##  4     1  1.67   0.0643 fail to reject
    ##  5     1  1.77   0.107  fail to reject
    ##  6     1  0.472  0.666  fail to reject
    ##  7     1  0.147  0.834  fail to reject
    ##  8     1  2.24   0.0114 reject        
    ##  9     1 -0.539  0.577  fail to reject
    ## 10     1  1.34   0.274  fail to reject
    ## # … with 290 more rows
