...
```
    ...
    ##    <dbl>  <dbl>   <dbl> <chr>         
    ##  1     1  1.37  0.118   fail to reject
    ##  2     1  0.507 0.631   fail to reject
    ##  3     1 -0.665 0.480   fail to reject
    ##  4     1  1.33  0.195   fail to reject
    ##  5     1 -0.439 0.643   fail to reject
    ##  6     1 -0.832 0.269   fail to reject
    ##  7     1  0.570 0.625   fail to reject
    ##  8     1  2.49  0.0112  reject        
    ##  9     1  1.10  0.224   fail to reject
    ## 10     1  3.33  0.00186 reject        
    ## # … with 290 more rows
