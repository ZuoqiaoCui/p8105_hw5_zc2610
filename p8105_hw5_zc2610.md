...
![](p8105_hw5_zc2610_files/figure-gfm/unnamed-chunk-10-1.png)<!-- -->
...
```
    ...
    ##    <dbl>   <dbl>   <dbl> <chr>         
    ##  1     1  1.17    0.140  fail to reject
    ##  2     1  0.863   0.332  fail to reject
    ##  3     1  0.723   0.498  fail to reject
    ##  4     1  0.354   0.709  fail to reject
    ##  5     1  0.929   0.329  fail to reject
    ##  6     1  1.29    0.192  fail to reject
    ##  7     1 -0.0417  0.962  fail to reject
    ##  8     1  1.54    0.107  fail to reject
    ##  9     1  0.484   0.595  fail to reject
    ## 10     1  1.61    0.0832 fail to reject
    ## # … with 290 more rows
