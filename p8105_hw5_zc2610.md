...
```
    ...
    ##    <dbl>   <dbl>   <dbl> <chr>         
    ##  1     1  2.17    0.0684 fail to reject
    ##  2     1  0.204   0.842  fail to reject
    ##  3     1 -0.0167  0.985  fail to reject
    ##  4     1  0.657   0.431  fail to reject
    ##  5     1  0.753   0.435  fail to reject
    ##  6     1  0.972   0.325  fail to reject
    ##  7     1 -0.0722  0.942  fail to reject
    ##  8     1  0.799   0.424  fail to reject
    ##  9     1  0.978   0.334  fail to reject
    ## 10     1  0.417   0.611  fail to reject
...
![](p8105_hw5_zc2610_files/figure-gfm/unnamed-chunk-13-1.png)<!-- -->
...
![](p8105_hw5_zc2610_files/figure-gfm/unnamed-chunk-14-1.png)<!-- -->
...
average_estimate_mu_reject = sim_results %>% 
  ...
  geom_line() +
  labs(
    title = "Average estimate of mu_hat vs True value of mu for 'rejected' samples",
     x = "True mu",
     y = "The average estimate of mu_hat"
  ) +
  theme(plot.title = element_text(hjust = 0.5))
...
![](p8105_hw5_zc2610_files/figure-gfm/unnamed-chunk-15-1.png)<!-- -->
