...
![](p8105_hw5_zc2610_files/figure-gfm/unnamed-chunk-9-1.png)<!-- -->
...
```
    ...
    ##    <dbl>  <dbl>   <dbl> <chr>         
    ##  1     1  1.43    0.132 fail to reject
    ##  2     1  1.11    0.179 fail to reject
    ##  3     1 -0.344   0.655 fail to reject
    ##  4     1 -0.913   0.293 fail to reject
    ##  5     1  0.518   0.631 fail to reject
    ##  6     1 -0.102   0.920 fail to reject
    ##  7     1 -0.232   0.728 fail to reject
    ##  8     1  0.784   0.339 fail to reject
    ##  9     1  0.773   0.446 fail to reject
    ## 10     1  1.19    0.117 fail to reject
    ## # … with 290 more rows
