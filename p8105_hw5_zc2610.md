...
```
    ...
    ##    <dbl>   <dbl>   <dbl> <chr>         
    ##  1     0  0.296  0.770   fail to reject
    ##  2     0 -2.30   0.00945 reject        
    ##  3     0 -0.0446 0.961   fail to reject
    ##  4     0  0.324  0.792   fail to reject
    ##  5     0 -0.0918 0.931   fail to reject
    ##  6     0 -0.989  0.321   fail to reject
    ##  7     0  1.55   0.116   fail to reject
    ##  8     0  0.440  0.609   fail to reject
    ##  9     0  0.283  0.783   fail to reject
    ## 10     0  0.698  0.492   fail to reject
