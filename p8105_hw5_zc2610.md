...
```
    ...
    ##    <dbl>    <dbl>   <dbl> <chr>         
    ##  1     1  2.35    0.0343  reject        
    ##  2     1  0.00302 0.998   fail to reject
    ##  3     1 -0.213   0.765   fail to reject
    ##  4     1  0.480   0.564   fail to reject
    ##  5     1  0.425   0.584   fail to reject
    ##  6     1  0.293   0.711   fail to reject
    ##  7     1 -0.263   0.748   fail to reject
    ##  8     1  0.678   0.531   fail to reject
    ##  9     1  2.80    0.00349 reject        
    ## 10     1  0.923   0.419   fail to reject
