...
```
    ...
    ##    <dbl>   <dbl>   <dbl> <chr>         
    ##  1     1  0.931   0.264  fail to reject
    ##  2     1  0.459   0.596  fail to reject
    ##  3     1  1.59    0.0607 fail to reject
    ##  4     1 -0.110   0.912  fail to reject
    ##  5     1 -0.178   0.824  fail to reject
    ##  6     1  1.59    0.132  fail to reject
    ##  7     1  0.611   0.542  fail to reject
    ##  8     1  0.903   0.295  fail to reject
    ##  9     1  0.0371  0.963  fail to reject
    ## 10     1  1.76    0.111  fail to reject
    ## # … with 290 more rows
